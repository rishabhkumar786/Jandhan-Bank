...
<body style="background:#FF0099;background-size: 100%">
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
 <a class="navbar-brand" href="#">
    <img src="images/bank2.png" width="30" height="30" class="d-inline-block align-top" alt="">
...
<div class="row w-100" >
  ...
  <h4 class="display-5">Welcome to Jandhan Bank</h4>
...
<div class="col">
    <div class="row" style="padding: 120px;padding-top: 200px">
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/account_summ-1470.jpg" style="max-height: 155px;min-height: 155px" alt="Card image cap">
          <div class="card-body">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/transfer2.jpg" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
    ...
    <div class="row" style="padding: 120px;padding-top: 5px">
      <div class="col">
        <div class="card shadowBlack ">
      ...
      <div class="col">
        <div class="card shadowBlack ">
          <img class="card-img-top" src="images/contacts2.gif" alt="Card image cap" style="max-height: 155px;min-height: 155px">
        <div class="card-body">
